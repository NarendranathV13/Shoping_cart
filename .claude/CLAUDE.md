# Operational Rules for Shopping Cart Project (Claude)

This document defines the strict operational rules, layer constraints, and code conventions governing all development work in the `Shopping_cart` repository for Claude AI agents.
...
| :--- | :--- |
| Reusing existing components & creating new reusable components | `.claude/skills/component-reusability-guide.md` |
| Executing API GET/POST/PUT/DELETE requests via ApiService | `.claude/skills/api-service-guide.md` |
| Managing Redux Toolkit state & Formik/Yup forms | `.claude/skills/redux-formik-guide.md` |
| Auditing commits & codebase changes against skill rules | `.claude/skills/skill-compliance-review.md` |
