...
- [ ] **Commit & Branch Output**: Review all changes in files across the workspace and based on those changes, provide a branch name formatted as `feat/feature-name` and a single-line conventional commit message (e.g., `Branch: feat/product-details-page | feat: implemented product details page`).
